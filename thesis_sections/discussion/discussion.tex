...
Agg and Agg SN:
-\emph{Nevskia} sp. are present in the aggregate at day 12 and then cease to exist at relevant levels at later time points for the aggregate. It is present in the slow growing, where colony formation takes about a week, and they prodce lipase \cite{kim2011nevskia}. This genera has been isolated as the most efficient surfactant producer and hence lipid remediation in palm oil mill effluent by Chooklin et al \cite{chooklinutilization}.
