...
The lipase activity observed in the average total activity of the control comes from the membrane bound lipase fraction. Activated sludge contains a baseline lipid concentration which serves as a C source which could explain the maintenance of lipase for rapid degradation. The 
