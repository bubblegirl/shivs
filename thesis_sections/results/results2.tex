...
The isolates LC1 - LC5 were isolated from lipid droplets in 1 \% GT enriched activated sludge. These were cultured on a minimal medium, with and without the presence of lipids. LC1 cultured in the presence of lipid displays a pink phenotype (Figure VA) and appears white when cultured in the abscence of lipis (Figure VB).


This further led to the question whether AHL profiles are affected by these culture conditions as well as morphology. 
